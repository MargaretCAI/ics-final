...
#==============================================================================
                ...
                if msg["message"] == "game":
                    to_name = the_guys[1:] # 记录我在和谁聊天
                    for name in to_name:
                        to_sock = self.logged_name2sock[name]
                         # 这个是该谁玩的state
                        mysend(to_sock,
                               json.dumps({"action": "gaming" }))
...
#==============================================================================
                ...
                from_name = self.logged_sock2name[from_sock]  # 记录谁发来的信息
                ...
                from_name = self.logged_sock2name[from_sock]  # 记录谁发来的信息
                to_name = self.group.list_me(from_name)[1:] # 记录我在和谁聊天
                ...
                for name in to_name:
                    ...
                    point = msg['point']
                    print(msg)
                    print("message is sent here")
                    print(game_num)
                    print(result)
                    print(point)
                    d = {"action": "gaming", "game_num": game_num, "result": result, "point": point}
                    mysend(to_sock, json.dumps(d))
