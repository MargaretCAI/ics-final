...
start_image = pygame.image.load("instruction/1024_ins.png")
...
def start_up_screen():
    while True:
        ...
        DISPLAY_SURF.blit(start_image, (10, 10))
        FPS_CLOCK.tick(60)
...
def main():
    ...
    global FONT_OBJ, TITLE_OBJ, BLOCK_BOARD
    pygame.init()
    ...
    FONT_OBJ = pygame.font.Font('font/SourceSansPro-Regular.ttf', FONT_SIZE)
    TITLE_OBJ = pygame.font.Font('font/SourceSansPro-Regular.ttf', TITLE_SIZE)
    ...
    while True:
        ...
        if len(main_board.blocks) >= (BOARD_WIDTH * BOARD_HEIGHT):
            ...
            # main_board = Board()
        elif (start_time + (PLAY_TIME * 1000) <= pygame.time.get_ticks()):
            return 1

        elif current_score < 1024:
        ...
        draw_timer(DISPLAY_SURF, 20, 30, time_left)
